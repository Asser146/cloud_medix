...
import 'package:cloud_medix/pre_load_app.dart';
...
void main() async {
  ...
  runApp(const PreloadApp()); // Show something quick

  await initializeApp(); // Do the heavy lifting in background
}
...
Future<void> initializeApp() async {
  ...
  String initialRoute = id != null ? Routes.home : Routes.login;
